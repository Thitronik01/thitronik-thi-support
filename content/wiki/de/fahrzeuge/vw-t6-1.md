...
2. T6.1 eindeutig vom T6 der Modelljahre 2015–2019 abgrenzen.
3. Universal-Set `100754` und Seriennummer ab `0823-019` bestätigen.
...
3. Beim T6.1 ausschließlich `SW2`, `SW3`, `SW4` und `SW6` auf `ON` stellen.
4. Alle anderen Schalter in der im Fahrzeughandbuch dargestellten Grundstellung belassen.
5. Nicht das darüber abgebildete T6-Profil `SW3 + SW4 + SW6` übernehmen.
...
3. Grüne Leitung messen und mit weiß/orange Pin `17` über einen gelgefüllten Verbinder verbinden.
...
1. DIP-Stellung `SW2 + SW3 + SW4 + SW6` und Seriennummer ab `0823-019` nochmals prüfen.
...
3. DIP-Stellung `SW2 + SW3 + SW4 + SW6` dokumentieren.
